...
extension String {
    func attributedString(withTextAlignment textAlignment : NSTextAlignment, fontName: String, fontSize size: CGFloat, fontColor color: Int, isUnderline: Bool = false) -> NSAttributedString {
